...
public class MethodRefEx6 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("person.introduceWithNumber1 = " + fun1.apply(person, 3));
        
        // 메서드 참조, 타입이 첫 번째 매개변수가 됨, 그리고 첫 번째 매개변수의 메서드를 호출, 나머지는 순서대로 매개변수에 전달
        BiFunction<Person, Integer, String> fun2 = Person::introduceWithNumber; // 타입::인스턴스메서드명
        System.out.println("person.introduceWithNumber2 = " + fun2.apply(person, 3));
    }
}
